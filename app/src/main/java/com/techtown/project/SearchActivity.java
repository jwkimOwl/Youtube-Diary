...
import com.techtown.project.VideoItem;
import com.techtown.project.YoutubeAdapter;
...
public class SearchActivity extends AppCompatActivity {
    ...
    public static Activity sSearchActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sSearchActivity=SearchActivity.this;
    ...
    private void fillYoutubeVideos(){
        ...
        youtubeAdapter.Year=Year;
        youtubeAdapter.Month=Month;
        youtubeAdapter.DayOfMonth=DayOfMonth;
        youtubeAdapter.Comment=Comment;
        youtubeAdapter.Video_Title= Video_Title;
        youtubeAdapter.Video_Id=Video_Id;
